...
def InitUsageConfig():
    ...
    config.usage.show_infobar_channel_number = ConfigYesNo(default=False)
    config.usage.show_second_infobar = ConfigSelection(default='2', choices=[('0', _('Off')),
     ('1', _('Event Info')),
    ...
    choicelist = [('show_menu', _('Show shutdown menu')),
     ...
     ('standby', _('Standby')),
     ('sleeptimerStandby', _('Sleeptimer Standby')),
     ('sleeptimerDeepStandby', _('Sleeptimer DeepStandby'))]
    ...
    config.usage.channelbutton_mode = ConfigSelection(default='0', choices=[('0', _('Just change channels')),
     ('1', _('Channel List')),
     ('2', _('Bouquet List')),
     ('3', _('Just change Bouquet'))])
    config.usage.updownbutton_mode = ConfigSelection(default='1', choices=[('0', _('Just change channels')), ('1', _('Channel List'))])
    ...
    config.plisettings.InfoBarEpg_mode = ConfigSelection(default='3', choices=[('0', _('as plugin in extended bar')),
     ('1', _('with long OK press')),
     ('2', _('with exit button')),
     ('3', _('with left/right buttons'))])
    if fileExists('/usr/lib/enigma2/python/Plugins/Extensions/CoolTVGuide/plugin.pyo'):
        config.plisettings.PLIEPG_mode = ConfigSelection(default='cooltvguide', choices=[('pliepg', _('Show Graphical EPG')),
        ...
        config.plisettings.PLIINFO_mode = ConfigSelection(default='coolinfoguide', choices=[('eventview', _('Show Eventview')),
         ('epgpress', _('Show EPG')),
         ('single', _('Show Single EPG')),
        ...
        config.plisettings.PLIEPG_mode = ConfigSelection(default='pliepg', choices=[('pliepg', _('Show Graphical EPG')),
         ('single', _('Show Single EPG')),
         ('multi', _('Show Multi EPG')),
         ('eventview', _('Show Eventview')),
         ('merlinepgcenter', _('Show Merlin EPG Center'))])
        config.plisettings.PLIINFO_mode = ConfigSelection(default='eventview', choices=[('eventview', _('Show Eventview')), ('epgpress', _('Show EPG')), ('single', _('Show Single EPG'))])
    ...
    config.epgselection.infobar_prevtimeperiod = ConfigSelection(default='300', choices=[('60', _('%d minutes') % 60),
     ('90', _('%d minutes') % 90),
     ('120', _('%d minutes') % 120),
     ('150', _('%d minutes') % 150),
     ('180', _('%d minutes') % 180),
    ...
    config.epgselection.graph_itemsperpage = ConfigSelectionNumber(default=6, stepwidth=1, min=3, max=20, wraparound=True)
