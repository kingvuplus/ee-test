...
class About(Screen):
	...
	def populate(self):
		self["lab1"] = StaticText(_("BlackHole"))
		self["lab2"] = StaticText(_("BlackHole Image"))
		model = None
		self["lab3"] = StaticText(_("Team Homesite") + " www.vuplus-community.net")
...
class AboutSummary(Screen):
	def __init__(self, session, parent):
		...
		self["selected"] = StaticText("BlackHole:" + getImageVersion())
